export default {
  tab1Render: {
    ...
    in_footer: "in footer",
    font_size: "Font size",
    colors_title: "Customize colors:",
    box_shadow_color: "Box border",
    anchor_color: "Anchor point",
    graph_color: "Lines",
    ball_color: "Animation dot",
    text_main_color: "Main value text",
    text_sub_color: "Sub value text",
    ball_size: "Animation dot size"
  },
  subtabRender: {
